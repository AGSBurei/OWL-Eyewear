...
class __TwigTemplate_83e8bf9d9c89f66cea378d6996ea6944d2332f77ccd61cd28697efcf37c97b6d extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 14
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 14, $this->source); })()), "confirm_password", [], "any", false, false, false, 14), 'row');
        echo "
...
";
    ...
    {
        return array (  98 => 17,  92 => 14,  87 => 12,  82 => 10,  77 => 8,  72 => 6,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% endblock %}
", "security/registration.html.twig", "/home/burei/Documents/OWL-Eyewear/templates/security/registration.html.twig");
    }
}
