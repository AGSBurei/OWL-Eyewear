...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        <script type=\"text/javascript\">
           \$('#clock').countdown(\"2019/10/26T12:00\", function(event) {
  ...
  <p></p>
        ...
        echo "
          ";
        // line 89
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 89, $this->source); })()), "email", [], "any", false, false, false, 89), 'row');
        echo " 
  ...
  <br>
      <div class=\"solution\">
        ...
        <p></p>
          <p>Les lunettes Owl Eyewear peuvent être portées <strong>dans toutes situations durant lesquelles la luminosité est faible </strong>
          (en ville ou à la campagne). Elles peuvent être portées au crépuscule, la nuit, dans le brouillard et pendant de fortes averses.</p>
            ...
            <p>Lorsque vous portez les lunettes, vous rendez les routes plus sûres, pour vous ainsi que pour les autres. Vous serez ravis des
             <strong>améliorations</strong> que vous apportera Owl Eyewear !</p>
        <p></p>
        ...
        echo "\" alt=\"pour qui\">
        <p></p>
        <p>Les lunettes Owl Eyewear peuvent être portées en <strong>voiture, à moto, à vélo et même en trottinette électrique, les conducteurs
           de camions et de bus peuvent également utiliser les lunettes !</strong></p>
      </div>
      <br>    
      ...
      <div class=\"framelst\">
        ...
        echo "\" alt=\"giflunetteportee\">
          <p><strong>Nous ne souhaitons pas proposer des lunettes adaptables à la vue</strong>, nous avons opté pour des <strong>surlunettes</strong>. <strong>Le confort visuel est identique</strong>, 
             le prix est plus intéressant et vous pouvez <strong>continuer à les utiliser si votre vue évolue.</strong></p>
...
<div class =\"myopienuit\">
      ...
      <p></p>
        ...
        <p>La nuit, les conducteurs sont <strong>légèrement myopisés</strong>, c’est pourquoi Nous avons conçu ces verres afin qu'ils puissent 
           compenser ce défaut pour toutes les personnes portant des lunettes ou non afin de vous apporter une <strong>vision parfaitement <br>
        ...
        echo "\" alt=\"imageAdaptation\">
                <p></p>
                <div class=\"text\"><p>L'adaptation aux lunettes OWL Eyewear est immédiate. Les verres jaunes, la compensation de la myopie nocturne et les traitements augmentent le confort visuel et la perception, mais n'induisent en aucun cas une détérioration ou des troubles de la vision. L’adaptation est immédiate car nous sélectionnons avec soin des verres de haute qualité pour répondre aux attentes des conducteurs.</p>
     </div>
      </div>
           <p></p>
           <p></p>
...
";
    ...
    {
        return array (  775 => 477,  760 => 465,  754 => 462,  742 => 453,  736 => 450,  721 => 438,  697 => 417,  690 => 413,  685 => 411,  680 => 409,  675 => 407,  670 => 405,  665 => 403,  659 => 400,  651 => 395,  646 => 393,  637 => 387,  632 => 385,  623 => 379,  617 => 376,  600 => 362,  594 => 359,  588 => 356,  582 => 353,  565 => 339,  556 => 333,  540 => 320,  535 => 318,  530 => 316,  525 => 314,  508 => 300,  500 => 295,  493 => 291,  482 => 283,  470 => 274,  465 => 272,  460 => 270,  449 => 262,  442 => 258,  435 => 254,  428 => 250,  420 => 245,  412 => 240,  404 => 235,  396 => 230,  388 => 225,  380 => 220,  371 => 214,  353 => 199,  337 => 186,  332 => 184,  327 => 182,  309 => 167,  290 => 151,  284 => 148,  279 => 146,  274 => 144,  267 => 140,  255 => 131,  248 => 127,  237 => 119,  230 => 115,  221 => 109,  214 => 105,  207 => 101,  199 => 96,  191 => 91,  186 => 89,  182 => 88,  169 => 78,  164 => 76,  92 => 6,  82 => 5,  69 => 3,  59 => 2,  36 => 1,);
    }
...
{% block body %}
  ...
  <br>
      ...
      <div class=\"framelst\">
          ...
          <p></p>
          <img class=\"spec\" src=\"{{ asset('build/images/carac.0257e035.png') }}\" alt=\"spec\">
          <p></p>
          <p></p>
          <p></p>
          <p>Il existe <strong>8 modèles de lunettes</strong>, disponibles <strong>uniquement sur Kickstarter</strong>.</p> 
       ...
       <div class=\"infoAdit\">    
          ...
          <p></p>
          <img class=\"imgOrigine\" src=\"{{ asset('build/images/FRFR.10367c6c.jpg') }}\" alt=\"imageg Origine\">
          <p></p>
