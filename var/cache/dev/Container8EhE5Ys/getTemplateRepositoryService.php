...
// Returns the private 'App\Repository\TemplateRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TemplateRepository.php';

return $this->privates['App\\Repository\\TemplateRepository'] = new \App\Repository\TemplateRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
