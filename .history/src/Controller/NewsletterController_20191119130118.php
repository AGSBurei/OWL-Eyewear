...
class NewsletterController extends AbstractController
{
    ...
    /**
     * @Route("/newsletter/stop/{id}", name="newsletter_stop_send")
     */
    public function newsletterStopSend(Newsletter $newsletter, EntityManagerInterface $manager)
    {
        if($newsletter->getIsActive()==true)
        {
